#Codenation - Aula de Estruturas de decisao
#Código verifica se o usuario é menor de idade
...
#Código verifica o tipo do veiculo
...
#Verificando se a variável possui algum valor com IF
verdad = 'Ao menos 1'
falso = ''
int_verd = 1 # Qualquer valor DIFERENTE de zero
int_falso = 0
#verdad, falso, int_verd, int_falso, True, None, [],{}
escolha = verdad
